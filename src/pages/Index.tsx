    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 text-center">
        <div className="max-w-6xl mx-auto">
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-warm-gold/80 mb-8 max-w-2xl mx-auto">
            ...
            <div className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
              <Link to="/menu">
                <Button className="bg-gold text-forest-green hover:bg-warm-gold font-semibold px-8 py-3 rounded-full transition-all duration-300 hover:scale-105">
                  View Our Menu
                  <ChevronRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
              <Link to="/franchise">
                <Button variant="outline" className="border-gold text-gold hover:bg-gold hover:text-forest-green font-semibold px-8 py-3 rounded-full transition-all duration-300 hover:scale-105">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <Link to="/about">
                <Button variant="outline" className="border-gold text-gold hover:bg-gold hover:text-forest-green">
                  Learn More About Us
                </Button>
              </Link>
            </div>
            <div className="text-center">
              ...
              <p className="text-warm-gold italic">"Food is our language of love"</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {signatureDishes.map((dish, index) => (
              <Card key={dish.name} className="bg-deep-green border-gold/20 hover:border-gold transition-all duration-300 hover:scale-105">
          ...
          <div className="text-center mt-8">
            <Link to="/menu">
              <Button className="bg-gold text-forest-green hover:bg-warm-gold font-semibold px-8 py-3 rounded-full">
                Explore Full Menu
              </Button>
            </Link>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-deep-green border-gold/20">
                <CardContent className="p-6">
                  <p className="text-warm-gold italic mb-4">
                    "{testimonial.text}"
                  </p>
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-warm-gold mb-8">
            Bring authentic South Indian cuisine to your city. 
            Discover our franchise opportunities and be part of our growing legacy.
          </p>
          <Link to="/franchise">
            <Button className="bg-gold text-forest-green hover:bg-warm-gold font-semibold px-8 py-4 text-lg rounded-full transition-all duration-300 hover:scale-105">
